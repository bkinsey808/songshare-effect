...
/**
 * Render a demo card that simulates heavy computation and reports render time.
 *
 * @param name - Display name for the demo block.
 * @param color - Tailwind color classes used for visuals.
