...
export default function UserView(): ReactElement {
	...
	if (error !== undefined && error !== "") {
		return (
			<div className="mx-auto max-w-3xl px-6 py-8 text-red-400">{t("userView.error", error)}</div>
		);
	}
	...
	return (
		<div className="mx-auto max-w-3xl px-6 py-8 space-y-6">
			<div className="flex items-center justify-between gap-4">
				...
				<ShareButton itemType="user" itemId={userPublic.user_id} itemName={userPublic.username} />
			</div>
