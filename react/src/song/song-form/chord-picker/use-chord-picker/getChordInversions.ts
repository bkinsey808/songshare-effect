...
import { INTERVAL_SEMITONE_OFFSET, OCTAVE_SEMITONE_COUNT, SEMITONE_INTERVAL_LABELS } from "../chordPickerConstants";
 ...
 */
export default function getChordInversions(
	...
	return candidates
		...
		.map(({ inversionIndex, bassRoot, reRootedSpelling }): ChordInversion => {
			const ordinalLabel =
