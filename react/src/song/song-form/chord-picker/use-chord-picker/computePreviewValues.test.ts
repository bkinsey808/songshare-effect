...
function makeBaseParams(): {
	...
	return {
		...
		activeInversion: undefined as ChordInversion | undefined,
...
describe("computePreviewValues", () => {
	...
	it.each([
		...
		},
		{
			...
			selectedBassNote: BASS_NOTE_E,
			activeInversion: forceCast<ChordInversion>({ matchedShape: undefined }),
		...
		},
		{
			...
			selectedBassNote: BASS_NOTE_E,
			activeInversion: forceCast<ChordInversion>({
