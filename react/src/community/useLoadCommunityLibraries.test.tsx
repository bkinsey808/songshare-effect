 ...
 *
 * @param userId - user id to pass to the hook
 * @param fetchSongLibrary - effect to fetch the song library
 * @param fetchPlaylistLibrary - effect to fetch the playlist library
