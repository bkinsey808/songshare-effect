...
export default async function stubGetSupabaseServerClient(mock: unknown): Promise<void> {
	...
	/* eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-type-assertion, @typescript-eslint/no-unsafe-argument -- test helper central cast */
