...
**Depends on:** [`file-organization/SKILL.md`](/.github/skills/file-organization/SKILL.md) — load when naming or import-policy decisions arise. [`source-refactoring/SKILL.md`](/.github/skills/source-refactoring/SKILL.md) — load when the split includes broader behavior-preserving refactor work.
