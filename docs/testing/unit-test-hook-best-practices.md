...
For general Vitest setup (mocking, pitfalls, API testing) see [unit-test-best-practices.md](/docs/testing/unit-test-best-practices.md).
...
See [unit-test-best-practices.md — forceCast and installStore](/docs/testing/unit-test-best-practices.md#forceCast-and-the-installStore-selector-dispatch-pattern)
...
See [docs/lint-best-practices.md#no-negated-condition](/docs/lint-best-practices.md#no-negated-condition).
...
- [ ] `act` / `waitFor` usage follows the general guidance in [unit-test-best-practices.md](/docs/testing/unit-test-best-practices.md#act-vs-waitfor)
