...
- Missing visitor token branch (see [realtime-rls-architecture skill](/skills/realtime-rls-architecture/SKILL.md))
...
Most likely RLS is silently filtering the subscriber. Confirm with the SQL simulation (Step 4), then verify the SELECT policy includes both visitor and user JWT paths. See [realtime-rls-architecture skill](/skills/realtime-rls-architecture/SKILL.md) for the verified production policy templates.
...
- Architecture + policy templates: [realtime-rls-architecture skill](/skills/realtime-rls-architecture/SKILL.md)
- JWT token structure: [authentication-system skill](/skills/authentication-system/SKILL.md)
