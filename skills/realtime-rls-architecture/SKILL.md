...
**Depends on:** [`authentication-system/SKILL.md`](/skills/authentication-system/SKILL.md) — load when token-claim behavior or JWT structure is in scope. [`realtime-rls-debugging/SKILL.md`](/skills/realtime-rls-debugging/SKILL.md) — load when the issue is active breakage (messages not arriving).
...
See [authentication-system skill](/skills/authentication-system/SKILL.md) for full token generation details.
...
- Debugging subscriptions: [realtime-rls-debugging skill](/skills/realtime-rls-debugging/SKILL.md)
