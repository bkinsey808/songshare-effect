...
**Depends on:** [`typescript-best-practices/SKILL.md`](/skills/typescript-best-practices/SKILL.md) — load when comment changes are driven by API clarity or type changes.
